...
const std::array< std::pair< int, int >, CPX_NUM_INT_PARS >
 CPXMILPSolver::CPLEX_to_SMSpp_int_pars{
 {
  ...
  { CPXPARAM_DistMIP_Rampup_Duration, intFirstCPLEXPar + 116 },
  { CPXPARAM_MIP_Cuts_LocalImplied, intFirstCPLEXPar + 117 },
  { CPXPARAM_MIP_Cuts_BQP, intFirstCPLEXPar + 118 },
  { CPXPARAM_MIP_Cuts_RLT, intFirstCPLEXPar + 119 },
  { CPXPARAM_MIP_SubMIP_StartAlg, intFirstCPLEXPar + 120 },
  { CPXPARAM_MIP_SubMIP_SubAlg, intFirstCPLEXPar + 121 },
  { CPXPARAM_MIP_SubMIP_Scale, intFirstCPLEXPar + 122 },
  { CPXPARAM_MIP_SubMIP_NodeLimit, intFirstCPLEXPar + 123 },
  { CPXPARAM_Preprocessing_SOS1Reform, intFirstCPLEXPar + 124 },
  { CPXPARAM_Preprocessing_SOS2Reform, intFirstCPLEXPar + 125 },
  { CPXPARAM_Barrier_Algorithm, intFirstCPLEXPar + 126 },
  { CPXPARAM_Barrier_ColNonzeros, intFirstCPLEXPar + 127 },
  { CPXPARAM_Barrier_Display, intFirstCPLEXPar + 128 },
  { CPXPARAM_Barrier_Limits_Iteration, intFirstCPLEXPar + 129 },
  { CPXPARAM_Barrier_Limits_Corrections, intFirstCPLEXPar + 130 },
  { CPXPARAM_Barrier_Ordering, intFirstCPLEXPar + 131 },
  { CPXPARAM_Barrier_StartAlg, intFirstCPLEXPar + 132 },
  { CPXPARAM_Barrier_Crossover, intFirstCPLEXPar + 133 },
  { CPXPARAM_Read_QPNonzeros, intFirstCPLEXPar + 134 },
  { CPXPARAM_Preprocessing_QCPDuals, intFirstCPLEXPar + 135 },
  { CPXPARAM_Preprocessing_QPMakePSD, intFirstCPLEXPar + 136 },
  { CPXPARAM_Preprocessing_QToLin, intFirstCPLEXPar + 137 },
  { CPXPARAM_Network_Iterations, intFirstCPLEXPar + 138 },
  { CPXPARAM_Network_Pricing, intFirstCPLEXPar + 139 },
  { CPXPARAM_Network_Display, intFirstCPLEXPar + 140 },
 }
};
