...
const std::array< std::pair< int, int >, CPX_NUM_DBL_PARS >
 CPXMILPSolver::CPLEX_to_SMSpp_dbl_pars{
 {
  ...
  { CPXPARAM_MIP_PolishAfter_AbsMIPGap, dblFirstCPLEXPar + 28 },
  { CPXPARAM_MIP_PolishAfter_MIPGap, dblFirstCPLEXPar + 29 },
  { CPXPARAM_MIP_PolishAfter_Time, dblFirstCPLEXPar + 30 },
  { CPXPARAM_MIP_Limits_ProbeDetTime, dblFirstCPLEXPar + 31 },
  { CPXPARAM_MIP_PolishAfter_DetTime, dblFirstCPLEXPar + 32 },
  { CPXPARAM_DistMIP_Rampup_DetTimeLimit, dblFirstCPLEXPar + 33 },
  { CPXPARAM_DistMIP_Rampup_TimeLimit, dblFirstCPLEXPar + 34 },
  { CPXPARAM_Barrier_ConvergeTol, dblFirstCPLEXPar + 35 },
  { CPXPARAM_Barrier_Limits_Growth, dblFirstCPLEXPar + 36 },
  { CPXPARAM_Barrier_Limits_ObjRange, dblFirstCPLEXPar + 37 },
  { CPXPARAM_Barrier_QCPConvergeTol, dblFirstCPLEXPar + 38 },
  { CPXPARAM_Network_Tolerances_Optimality, dblFirstCPLEXPar + 39 },
  { CPXPARAM_Network_Tolerances_Feasibility, dblFirstCPLEXPar + 40 },
 }
};
